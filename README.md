...
Once the `conda-forge` channel has been enabled, `heyoka, heyoka-llvm-14, heyoka-llvm-15, heyoka-llvm-16, heyoka-llvm-17, heyoka-llvm-18` can be installed with `conda`:

```
conda install heyoka heyoka-llvm-14 heyoka-llvm-15 heyoka-llvm-16 heyoka-llvm-17 heyoka-llvm-18
```

or with `mamba`:

```
mamba install heyoka heyoka-llvm-14 heyoka-llvm-15 heyoka-llvm-16 heyoka-llvm-17 heyoka-llvm-18
```
